import fs from 'fs';
import type { ResponseLike } from 'steamship-max-test/internal/to-file';
import { toFile } from 'steamship-max-test/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('steamship-max-test/core/uploads');
    await expect(
